...
func TestGet(t *testing.T) {
	...
	err := bb.Open(ts.URL + "/page1")
	ut.AssertNil(err)
	ut.AssertContains("Surf Page 1", bb.InnerText())

	err = bb.Open(ts.URL + "/page2")
	ut.AssertNil(err)
	ut.AssertContains("Surf Page 2", bb.InnerText())
...
func TestPost(t *testing.T) {
	...
	bb := NewBrowser()
	bb.Post(ts.URL, "application/x-www-form-urlencoded", nil)
	ut.AssertEquals(200, bb.StatusCode())
}
...
func TestUserAgent(t *testing.T) {
	...
	bb := NewBrowser()
	bb.SetUserAgent("Testing/1.0")
	err := bb.Open(ts.URL)
	ut.AssertNil(err)
	ut.AssertContains("Testing/1.0", bb.InnerText())
}
...
func TestHeaders(t *testing.T) {
	...
	bb := NewBrowser()
	bb.AddRequestHeader("X-Testing-1", "Testing-1")
	bb.AddRequestHeader("X-Testing-2", "Testing-2")
	err := bb.Open(ts.URL)
	ut.AssertNil(err)
	ut.AssertContains("Testing-1", bb.InnerText())
	ut.AssertContains("Testing-2", bb.InnerText())
}

// TestHeadersSet
// See: https://github.com/llakes/surf/pull/19
func TestHeadersBug19(t *testing.T) {
	...
	bb := NewBrowser()
	bb.AddRequestHeader("X-Testing", "Testing-1")
	bb.AddRequestHeader("X-Testing", "Testing-2")
	err := bb.Open(ts.URL)
	ut.AssertNil(err)
	ut.AssertContains("Testing-2", bb.InnerText())
}
...
func TestBookmarks(t *testing.T) {
	...
	bb := NewBrowser()
	bb.SetBookmarksJar(bookmarks)

	bookmarks.Save("test1", ts.URL)
	bb.OpenBookmark("test1")
	ut.AssertContains("Surf Page 1", bb.InnerText())

	err := bb.Bookmark("test2")
	ut.AssertNil(err)
	bb.OpenBookmark("test2")
	ut.AssertContains("Surf Page 1", bb.InnerText())
}
...
func TestClick(t *testing.T) {
	...
	err = bb.Click("//a[contains(@href,'/page2')]")
	panicIf(err)
	ut.AssertNil(err)
	ut.AssertContains("<p>Hello, Surf!</p>", bb.InnerText())
}
